              ...
              if(!empty($user)){   
                foreach($user as $row){    
                  ...
                  <div class="billing_address">
                    ...
                    <span class="delete_bill_address"><a href="?action=delete_ocma&did=<?php echo esc_attr($row->id);?>"><?php echo esc_html('Delete');?></a></span><br>
              ...
              if(!empty($user_shipping)){
                foreach($user_shipping as $row){    
                  ...
                  <div class="shipping_address">
                    ...
                    <span class="delete_ship_address"><a href="?action=delete-ship&did-ship=<?php echo esc_attr($row->id);?>"><?php echo esc_html('Delete');?></a></span><br>
